...
<!-- <script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=490437ce50e900f35617a529b717619d&​libraries=services"></script> -->
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=902b2028b9315270cdff50a6e9f81c9a&libraries=services"></script>
	...
	<div id="place_section">
		...
		<div class="place_main">
			...
			<div class="place_main_map" id="map" style="width:500px; height:400px; margin-top:0;"></div>
		</div>
		<hr class="place_hr">
			...
			<div class="place_main_content default">
				...
				<div class="place_main_content_button">
					<button type="button" onclick="location.href='/walkpet/shop/shopDetail?seq=${pdto.shopSeq}'">더보기</button>
				</div>
			</div>
			</c:forEach>
	</div>
			...
			$.ajax({
                ...
                success: function (result) {
					...
					for(var i in jdata.jlist){
						...
						addListHtml += '</div><div class="place_main_content_button"><button type="button" onclick="location.href=\'/walkpet/shop/shopDetail?seq='+jdata.jlist[i].shopSeq+'\'">더보기</button></div></div>';
					}
					$(".default").remove();
					$(".place_add").remove();
